...
export function useAirbnb() {
    ...
    return { airbnbs, bookings, addAirbnb,updateAirbnb, editListing, removeAirbnb,bookAirbnb, cancelBooking, initializeUser , initialized , loading, transactionPending}
}